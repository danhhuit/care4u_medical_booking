...
class _ChatBotScreenState extends State<ChatBotScreen> {
  ...
  final List<Map<String, String>> _messages = [
    {
      'type': 'bot',
      'text': AppTranslations.tr('ai_greeting'),
    },
  ];
  ...
  void _sendMessage() {
    ...
    Future.delayed(const Duration(milliseconds: 1000), () {
      ...
      setState(() {
        _messages.add({
          'type': 'bot',
          'text': AppTranslations.tr('ai_bot_response'),
        });
      });
    });
  }
    ...
    return ValueListenableBuilder<String>(
      ...
      builder: (context, lang, _) {
        return Scaffold(
          ...
          appBar: AppBar(
            title: Text(AppTranslations.tr('ai_assistant_title')),
            centerTitle: true,
                      ...
                      Expanded(
                        child: TextField(
                          ...
                          decoration: InputDecoration(
                            hintText: AppTranslations.tr('type_message'),
